...
import { FaEye, FaEdit, FaTrash, FaQrcode, FaHistory } from "react-icons/fa";
import { COLORS, STATUS_COLORS, CONDITION_COLORS } from "../../theme/tokens";
import StatusPill from "../common/StatusPill";
import ActionBtn  from "../common/ActionBtn";

const HEADERS = ["Asset ID ↕", "Asset Name ↕", "Asset Code ↕", "Value ↕", "Type ↕", "Location ↕", "Status ↕", "Condition ↕", "Actions ↕"];

export default function AssetTable({ assets, loading, canWrite = true, onView, onEdit, onDelete, onQR, onHistory }) {
  return (
